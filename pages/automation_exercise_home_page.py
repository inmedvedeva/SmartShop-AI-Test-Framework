...
class AutomationExerciseHomePage(BasePage):
    ...
    PRODUCT_NAMES = (By.CSS_SELECTOR, ".product-information h2")
    PRODUCT_PRICES = (By.CSS_SELECTOR, ".product-information span span")
    ...
    def open_home_page(self):
        """Open the home page"""
        logger.info(f"Opening Automation Exercise home page: {self.url}")
        ...
        for product in products:
            try:
                ...
                price_element = product.find_element(
                    By.CSS_SELECTOR, ".product-information span span"
                )
    ...
    def is_newsletter_subscribed(self):
        """Check if newsletter subscription was successful"""
        try:
            success_message = self.find_element(self.SUBSCRIPTION_SUCCESS)
            return "You have been successfully subscribed!" in success_message.text
        except:
            return False
